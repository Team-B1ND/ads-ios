...
public struct Shimmer<C: View>: View {
    ...
    public var body: some View {
        let color = colorProvider.isDarkTheme ? Color.white.opacity(0.7) : AlimoPallete.shared.Neutral90.opacity(0.1)
        let midColor = colorProvider.isDarkTheme ? Color.white.opacity(0.2) : AlimoPallete.shared.Neutral90.opacity(0.2)
